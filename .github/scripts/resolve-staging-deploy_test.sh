...
run_resolver() {
  ...
  env \
    ...
    STAGING_TOS_STORAGE_ROLE_TRN=trn:iam::1234567890:role/keystone-staging-storage \
...
expect_failure "non-staging storage role" STAGING_TOS_STORAGE_ROLE_TRN=trn:iam::1234567890:role/keystone-storage
